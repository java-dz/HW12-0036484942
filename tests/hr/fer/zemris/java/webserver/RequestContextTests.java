...
public class RequestContextTests {
	...
	public void testGetTemporaryParameter() {
		...
		new SmartScriptEngine(
			new SmartScriptParser(readFromDisk("fibonacci.smscr")).getDocumentNode(),
			rc
		).execute();
		
		assertEquals("21", rc.getTemporaryParameter("a"));
		assertEquals("34", rc.getTemporaryParameter("b"));
	...
	public void testGetTemporaryParameterNames() {
		...
		Set<String> temporaryParameterNames = rc.getTemporaryParameterNames();
		assertTrue(temporaryParameterNames.contains("a"));
		assertTrue(temporaryParameterNames.contains("b"));
	}
